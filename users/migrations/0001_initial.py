    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cursos', models.ManyToManyField(related_name='users', to='cursos.curso')),
                ('especialidades', models.ManyToManyField(related_name='users', to='especialidades.especialidade')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('licenca_medica', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='licencas_medicas.licenca_medica')),
